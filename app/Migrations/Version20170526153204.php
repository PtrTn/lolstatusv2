 ...
 */
class Version20170526153204 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE `Update` (id INT AUTO_INCREMENT NOT NULL, updateId VARCHAR(255) NOT NULL, author VARCHAR(255) DEFAULT NULL, content VARCHAR(255) NOT NULL, severity VARCHAR(255) NOT NULL, createdAt DATETIME NOT NULL, updateAt DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
